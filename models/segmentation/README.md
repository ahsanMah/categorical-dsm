> Note: This (sub)-repo is cloned from the torchvision official references
> https://github.com/pytorch/vision/tree/93df9a50885d0345e31bba691576c83d5cee7737/references/segmentation
> We mostly make use of the provided transformations and data utils
