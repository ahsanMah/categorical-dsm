...
#### Helper functions ported from score_sde.layers ####
...
#     # Pass through function as the initialization will be done in score_base
#     return lambda x_size: torch.empty(x_size)
